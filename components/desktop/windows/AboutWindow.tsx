...
const AboutWindow = () => {
  return (
    <div className="bg-neutral-950 p-6 text-white sm:p-10">
      <h2 className="accent mb-8 text-3xl font-bold sm:text-4xl">About Me</h2>
      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8">
        ...
        {/* Experience includes */}
        <p className="mb-4 font-semibold accent">My experience includes:</p>
        <ul className="mb-6 grid list-disc grid-cols-1 gap-x-8 gap-y-2 pl-5 text-white/85 sm:grid-cols-2 lg:grid-cols-3">
          {experience.map((item) => (
            <li key={item}>{item}</li>
          ))}
        </ul>
        ...
        <div className="mt-8 border-t border-white/10 pt-6">
          <p className="mb-4 font-semibold accent">Education</p>
          <div className="flex flex-col justify-between gap-1 sm:flex-row sm:items-start">
            <div>
              <h4 className="font-semibold text-white">Amity University, Patna</h4>
